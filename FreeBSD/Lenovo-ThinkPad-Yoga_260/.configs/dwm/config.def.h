...
static const char *fonts[]          = {
        "Anonymous Pro:size=8",
        "Siji:size=8",
};
static const char dmenufont[]       = "Anonymous Pro:size=8";
static const char col_bg[]          = "#080808";
static const char col_bl[]          = "#181818";
static const char col_fg[]          = "#c3d4f8";
static const char col_wh[]          = "#c3d4f8";
static const char col_cn[]          = "#ff0000";
...
static const Rule rules[] = {
	...
	{ "burp-",    NULL,       NULL,       1 << 7,       0,           -1 },
	{ "Postman",    NULL,       NULL,       1 << 7,       0,           -1 },
	{ "install4j-",  NULL,    NULL,       1 << 7,       0,           -1 },
...
static const char *dmenucmd[] = { "dmenu_run", "-h", "20", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg, "-nf", col_fg, "-sb", col_cn, "-sf", col_wh, NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_Escape,      quit,           {0} },
        ...
        { 0, XF86XK_AudioMute,		spawn,		SHCMD("toggle_mute; pkill -RTMIN+10 dwmblocks")},
        { 0, XF86XK_AudioLowerVolume,   spawn,		SHCMD("changeVolume 2dB-; pkill -RTMIN+10 dwmblocks")},
        { 0, XF86XK_AudioRaiseVolume,	spawn,		SHCMD("changeVolume 2dB+; pkill -RTMIN+10 dwmblocks")},
};
