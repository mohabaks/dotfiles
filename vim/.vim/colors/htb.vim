...
" Theme:        htb.vim
" Description:  A vim colorcheme based on https://github.com/mohabaks/dotfiles/blob/master/colors/.colors/htb.
"
hi clear
set background=dark
...
hi ColorColumn ctermbg=0 ctermfg=7 cterm=NONE
...
hi pythonImport ctermbg=NONE ctermfg=5 cterm=NONE
hi pythonFunction ctermbg=NONE ctermfg=3 cterm=NONE
hi pythonBoolean ctermbg=NONE ctermfg=4 cterm=NONE
hi pythonDot ctermbg=NONE ctermfg=6 cterm=NONE
hi pythonQuotes ctermbg=NONE ctermfg=6 cterm=NONE
hi pythonStatement ctermbg=NONE ctermfg=5 cterm=Bold
hi pythonDef ctermbg=NONE ctermfg=1 cterm=Bold
hi pythonOperator ctermbg=NONE ctermfg=1 cterm=Bold
hi pythonBuiltIn ctermbg=NONE ctermfg=6 cterm=NONE
hi pythonBuiltinFunc ctermbg=NONE ctermfg=4 cterm=NONE
hi pythonFunctionCall ctermbg=NONE ctermfg=3 cterm=NONE
hi pythonConditional ctermbg=NONE ctermfg=5 cterm=NONE
